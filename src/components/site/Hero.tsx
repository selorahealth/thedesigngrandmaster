...
import portrait from "@/assets/samuel.png"; 
...
export function Hero() {
    ...
    const onScroll = () => {
      ...
      raf = requestAnimationFrame(() => {
        if (portraitRef.current) {
          portraitRef.current.style.transform = `translate3d(0, ${window.scrollY * 0.14}px, 0)`;
        }
      });
    };
  ...
  return (
    <section
      id="top"
      className="relative overflow-hidden bg-ink pt-28 pb-16 sm:pt-32 lg:pt-44 lg:pb-28"
    >
      <div className="shell grid items-center gap-10 lg:grid-cols-[1.05fr_1fr] lg:gap-6">
        ...
        >
          ...
          <h1 className="display mt-5 text-[clamp(2.1rem,8.5vw,5.5rem)] leading-[1.05] sm:text-[clamp(2.75rem,7vw,5.5rem)]">
          ...
          <p className="mt-6 max-w-lg text-[0.95rem] leading-relaxed text-muted-foreground sm:text-base">
            I build websites, apps and graphic identities from scratch. Every
            project is drawn, written and shipped from scratch.
          </p>
        ...
        <div className="relative order-1 lg:order-2">
          ...
          <div ref={portraitRef} className="relative will-change-transform">
            <img
              src={portrait}
              alt="Samuel Amanze — Thedesigngrandmaster"
              width={1024}
              height={1024}
              className="mx-auto w-full max-w-[280px] select-none rounded-2xl object-cover sm:max-w-[360px] lg:max-w-[440px]"
            />
          </div>
