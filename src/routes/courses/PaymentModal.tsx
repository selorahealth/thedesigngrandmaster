...
export function PaymentModal({ open, onClose, course }: Props) {
  ...
  const whatsappText = course.whatsappMessage.replace("{fullName}", fullName || "Student");
  const whatsappUrl = `https://wa.me/2349065718162?text=${encodeURIComponent(whatsappText)}`; // ← replace with your real number
        ...
        {step === "confirm" && (
          <>
            ...
            <p className="mt-4 text-xs text-center text-muted-foreground">
              You will receive the link to your course folder and access to the private community after confirmation.
            </p>
            <button
              onClick={onClose}
